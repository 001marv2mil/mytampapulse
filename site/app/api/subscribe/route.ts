...
// Service role key required: RLS is enabled on subscribers/referrals,
...
const MILESTONES: Record<number, { prize: string; description: string }> = {
  ...
  10: { prize: "Ray-Ban Meta smart glasses",          description: "you're entered to win Ray-Ban Meta smart glasses — winner announced monthly" },
            ...
            html: `
              <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 20px; color: #1a1a1a;">
                ...
                <p style="font-size: 14px; line-height: 1.7; color: #666;">
                  Keep sharing — at <strong>5 referrals</strong> you&apos;re entered for a $250 Tampa Bay gift card. At <strong>10</strong>, Ray-Ban Meta smart glasses. At <strong>25</strong>, dinner for 2 at Bern&apos;s Steak House.
                </p>
      ...
      html: isEventSignup ? `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 20px; color: #1a1a1a;">
          ...
          <div style="border: 1px solid #eee; border-radius: 12px; padding: 20px; margin: 24px 0;">
            ...
            <p style="font-size: 13px; color: #444; margin: 0 0 3px;">10 referrals Ray-Ban Meta smart glasses giveaway</p>
