      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            ...
            <p className="text-pulse-orange text-xs font-bold tracking-[0.3em] uppercase mb-3">Real Issue · #13</p>
            ...
            <div className="space-y-3 mb-8">
              {["Zero filler. Every pick earns its spot.", "Written in plain English, not marketing copy.", "Covers all of Tampa Bay — Ybor, SoHo, St. Pete, Seminole Heights.", "Delivered Friday so you can actually use it this weekend."].map((point) => (
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl border border-gray-100 p-5 flex items-start gap-4 blur-sm select-none">
              ...
              <div className="absolute inset-0 flex items-center justify-center rounded-2xl bg-white/80 backdrop-blur-[2px]">
                <Link href="/#subscribe">
                  <span className="bg-pulse-orange text-white font-black text-xs px-4 py-2 rounded-full shadow-lg">
                    Subscribe to unlock →
                  </span>
                </Link>
              </div>
