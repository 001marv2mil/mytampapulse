"""
@petoshealth — Fun Fact Instagram Stories
...
LOG_FILE       = Path(__file__).parent / 'petos_story_log.json'
REPOST_DAYS    = 30
RETENTION_DAYS = 90
...
def draw_slide(photo, headline):
    """Draw a single story slide: photo background + dark gradient + PETOSHEALTH brand + headline."""
    ...
    out_path = Path(__file__).parent / 'petos_story_slide.png'
...
if __name__ == '__main__':
    ...
    print('=== PETOSHEALTH — FUN FACT STORIES ===')
    log = load_log()
